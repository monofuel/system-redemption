...
async function copyFiles() {
  ...
  fs.copyFileSync('node_modules/bulma/css/bulma.css.map', 'build/client/bulma.css.map');

  fs.copyFileSync('node_modules/bootstrap/dist/css/bootstrap.css', 'build/client/bootstrap.css');
  fs.copyFileSync('node_modules/bulma/dist/css/bootstrap.css.map', 'build/client/bootstrap.css.map');

  fs.copyFileSync('bulmaswatch/solar/bulmaswatch.min.css', 'build/client/bulmaswatch.min.css');
  fs.copyFileSync('bulmaswatch/solar/bulmaswatch.min.css.map', 'build/client/bulmaswatch.min.css.map');
  ...
  fs.copyFileSync('node_modules/three.xr.js/dist/three.xr.js', 'build/client/three.xr.js');
